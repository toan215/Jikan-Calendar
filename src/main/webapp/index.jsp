<%-- Document : index Created on : Jun 21, 2025, 2:32:53 PM Author : DELL --%>
  ...
  */ } } } System.out.println("================================="); %>
  ...
  <body>
    ...
    >
      ...
      <div
        class="relative z-10 flex flex-col items-center text-center text-white px-4"
      >
        ...
        <p class="italic text-base md:text-lg max-w-2xl mb-8">
          Time is a priceless resourceΓÇöfree to everyone, yet impossible to
          own. You can spend it, use it, or waste it, but you can never store or
          retrieve it once it's gone. Every second matters, because lost time is
          lost forever.
        </p>
        <img
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          ...
          <div>
            <div class="flex justify-center mb-4">
              <!-- Calendar Icon SVG -->
              <img
                src="<%=request.getContextPath()%>/assets/Calendar.svg"
                alt="Calendar"
                class="w-12 h-12"
              />
            </div>
            ...
            <p class="text-gray-500 text-sm">
              Automatically sync your course enrollment with your calendar.
              Never miss a class ΓÇô view, plan, and manage your entire learning
          ...
          <div>
            <div class="flex justify-center mb-4">
              <!-- Share Icon SVG -->
              <img
                src="<%=request.getContextPath()%>/assets/Share.svg"
                alt="Share"
                class="w-12 h-12"
              />
            </div>
            ...
            <p class="text-gray-500 text-sm">
              With shared calendars, everyone stays aligned ΓÇö view common
              schedules, co-manage events, assign roles (view/edit), and avoid
              conflicts. Perfect for classrooms, project teams, or multi-user
          ...
          <div>
            <div class="flex justify-center mb-4">
              <!-- Check Icon SVG -->
              <img
                src="<%=request.getContextPath()%>/assets/Checkcircle.svg"
                alt="Check"
                class="w-12 h-12"
              />
            </div>
            ...
            <p class="text-gray-500 text-sm">
              Create to-dos, assign deadlines, set priorities, and track
              progress ΓÇö all directly within your calendar. Stay organized and
              focused with tasks that sync with your schedule.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="flex-1">
          ...
          <p class="text-gray-500 text-base md:text-lg mb-6 max-w-xl">
            Based on your availability, workload, and priorities, our
            intelligent engine suggests the most optimal time slots. Say goodbye
            to scheduling conflicts and decision fatigue.
          </p>
          <ul class="space-y-4">
            <li class="flex items-center text-gray-700 text-base">
              <span
                class="inline-flex items-center justify-center w-7 h-7 rounded-full bg-sky-100 mr-3"
              >
                <svg
    ...
    <section id="pricing" class="bg-[#f9fbfd] py-20">
      <div class="max-w-6xl mx-auto px-4">
        <h2
          class="text-3xl md:text-4xl font-bold text-center mb-12 tracking-wide"
        >
          OUR PRICING
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <!-- Basic Plan -->
          <div
            class="bg-white rounded-xl shadow-sm flex flex-col items-center pb-8"
          >
            <div
              class="w-full bg-sky-400 rounded-t-xl py-6 flex flex-col items-center"
            >
              <span class="text-white font-bold text-xl tracking-wider"
                >BASIC PLAN</span
              >
              <span class="text-white font-semibold text-base text-lg mt-1"
                >FREE</span
              >
            </div>
            <ul
              class="text-black-700 text-center text-md mt-6 mb-8 space-y-4 px-6"
            >
            ...
            <a
              href="signup"
              class="border border-sky-400 text-sky-400 px-8 py-1 rounded transition hover:bg-sky-50 font-medium"
              >SIGN UP</a
            >
          </div>
          <!-- Plus Plan -->
          ...
          >
            ...
            >
              <span class="text-white font-bold text-xl tracking-wider"
                >PLUS PLAN</span
              >
              <span class="text-white font-bold text-base text-lg mt-1"
                >$11</span
              >
          ...
          >
            ...
            <ul
              class="text-gray-700 text-center text-sm mt-6 mb-8 space-y-2 px-6"
            >
      ...
      >
        ...
        >
          ...
          <p class="text-gray-500 text-base md:text-lg mb-8 max-w-md">
            Take control of your time with our intelligent calendar system ΓÇö
            built for learners, teams, and professionals. From smart scheduling
            to shared calendars and task tracking, everything you need is just
            one click away.
          </p>
          <a
            href="login"
            class="bg-sky-400 hover:bg-sky-500 text-white font-bold px-10 py-3 rounded-xl transition w-48 text-center"
          >
            SIGN IN
          </a>
        </div>
    ...
    >
      ...
      <div
        class="relative z-10 w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-20 gap-12"
      >
        <!-- Left: Contact Info -->
        <div class="flex-1 text-white">
          ...
          <p
            class="mb-6 text-gray-200 text-base md:text-lg text-center md:text-left"
          >
          ...
          <ul class="space-y-5 text-base">
            <li class="flex items-center">
              <span
                class="inline-flex items-center justify-center w-9 h-9 rounded-full bg-sky-500 bg-opacity-20 mr-4"
              >
                <!-- Location Icon -->
                <img
                  src="<%=request.getContextPath()%>/assets/location.svg"
                  alt="Location"
                  class="w-6 h-6"
                />
              </span>
            ...
            <li class="flex items-center">
              ...
              >
                <!-- Phone Icon -->
                <img
                  src="<%=request.getContextPath()%>/assets/phone.svg"
                  alt="Phone"
                  class="w-6 h-6"
                />
              </span>
            ...
            <li class="flex items-center">
              ...
              >
                <!-- Email Icon -->
                <img
                  src="<%=request.getContextPath()%>/assets/email.svg"
                  alt="Email"
                  class="w-6 h-6"
                />
              </span>
        ...
        <!-- Right: Contact Form -->
        <form
          class="flex-1 bg-white bg-opacity-90 rounded-lg shadow-lg p-8 space-y-6 min-w-[320px] max-w-md mx-auto"
        >
          <div class="flex gap-4">
            <input
              type="text"
              placeholder="Name"
              class="w-1/2 px-4 py-3 rounded bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-sky-400"
            />
            <input
              type="email"
              placeholder="Email"
          ...
          <input
            type="text"
            placeholder="Subject"
            class="w-full px-4 py-3 rounded bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-sky-400"
          />
          <textarea
            placeholder="Message"
            rows="4"
          ...
          <button
            type="submit"
            class="w-full bg-sky-400 hover:bg-sky-500 text-white font-bold py-3 rounded-lg transition text-lg shadow"
          >
            Send
          </button>
        </form>
